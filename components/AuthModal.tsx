...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      <div
        onClick={onClose}
        className="fixed inset-0 bg-black/90 backdrop-blur-md z-[200] auth-modal-overlay"
      />
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md z-[201] p-1 auth-modal-panel">
