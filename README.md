...
- Firebase Web client config (required on frontend):
  ...
  - optional: `NEXT_PUBLIC_PASSWORD_RESET_URL` (`https://hammadtools.com/reset-password`)
...
For Hostinger production, define the same environment variable names in Hostinger's environment settings (do not hardcode secrets in code).
